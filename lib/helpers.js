...
HelperSet.prototype.contentTag = function(name, content, params, override) {
    return genericTag(name, content || '', params, override);
};

HelperSet.prototype.content_tag = HelperSet.prototype.contentTag;
